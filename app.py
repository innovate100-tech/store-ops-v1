        ...
        for idx, (label, sales) in enumerate(scenarios):
            ...
            with tile_col:
                ...
                <div style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding: 1.2rem; border-radius: 10px; margin-top: 0.8rem; color: #e5e7eb; box-shadow: 0 2px 6px rgba(0,0,0,0.35);">
                    ...
                    <!-- 매출 영역: 흰색 -->
                    <div style="font-size: 1.3rem; font-weight: 700; margin-bottom: 0.3rem; color: #ffffff;">
                        매출: {int(sales):,}원
                    </div>
                    <!-- 비용 영역 제목: 빨간색 계열 -->
                    <div style="font-size: 0.9rem; margin-top: 0.5rem; border-top: 1px solid rgba(148,163,184,0.5); padding-top: 0.5rem; color: #f97373;">
                        비용 합계 및 세부내역
                    </div>
                    <!-- 총 비용: 빨간색 -->
                    <div style="font-size: 1.1rem; font-weight: 600; margin-bottom: 0.2rem; color: #f97373;">
                        총 비용: {int(total_cost):,}원
                    </div>
                    <div style="font-size: 0.85rem; margin-top: 0.3rem; line-height: 1.4; color: #f97373;">
                    ...
                    <!-- 추정 영업이익 제목: 노란색 -->
                    <div style="font-size: 0.9rem; margin-top: 0.5rem; border-top: 1px solid rgba(148,163,184,0.5); padding-top: 0.5rem; color: #facc15;">
                        추정 영업이익
                    </div>
                    <!-- 추정 영업이익 값: 노란색 -->
                    <div style="font-size: 1.1rem; font-weight: 600; color: #facc15;">
                        {int(profit):,}원
                    </div>
                </div>
                """, unsafe_allow_html=True)
