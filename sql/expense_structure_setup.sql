-- ============================================
-- Expense Structure Table 추가 (Supabase SQL Editor에서 실행)
-- ============================================
-- 기존 schema.sql이 이미 실행된 경우, 이 SQL만 실행하면 됩니다.
...
CREATE TABLE IF NOT EXISTS expense_structure (
    ...
    amount NUMERIC(12, 2) NOT NULL DEFAULT 0,  -- 고정비는 금액, 변동비는 비율(%)로 저장되므로 소수점 허용
    notes TEXT,  -- 메모 (선택사항)
